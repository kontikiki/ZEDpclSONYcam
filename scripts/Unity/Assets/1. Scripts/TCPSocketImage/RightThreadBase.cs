...
public class RightThreadBase : MonoBehaviour
{
...
public void ByteArrayToImage(byte[] bytes)
    {
        ...
        Debug.Log("Write to right material image");
    ...
    {
        m_TcpListener = new TcpListener(IPAddress.Any, m_Port2);
        m_TcpListener.Start();
