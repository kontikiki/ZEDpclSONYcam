...
public class PointCloudRenderer_2 : MonoBehaviour
{
    public PointCloudSubscriber_2 subscriber;
    ...
    public Color[] colours = new Color[] { new Color(0f, 0f, 0f), new Color(0f, 0f, 0f) };
