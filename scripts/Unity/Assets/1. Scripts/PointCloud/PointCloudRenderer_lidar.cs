...
public class PointCloudRenderer_lidar : MonoBehaviour
{
    public PointCloudSubscriber_lidar subscriber;
    ...
    public Vector3[] positions = new Vector3[] { new Vector3(0, 0, 0), new Vector3(0, 1, 0) };
    public Color[] colours = new Color[] { new Color(1f, 0f, 0f), new Color(0f, 1f, 0f) };
    ...
    void Start()
    {
        ...
        //positions=new Vector3[subscriber.size];
        //colours=new Color[subscriber.size];
    ...
    /*
    for(int n=0;n<positions.GetLength(0);n++)
    {
        Debug.Log("positions[n]: "+positions[n].x);
    }
    */
        ...
        mesh.colors = colours;
        //Debug.Log("Positions num: "+positions.Length);
