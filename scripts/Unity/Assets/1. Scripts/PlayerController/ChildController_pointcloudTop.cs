...
public class ChildController_pointcloudTop : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //originCamera.transform=transform;
        ...
        originCamera.transform.position=transform.position;
   originCamera.transform.rotation=transform.rotation;
    }
...
//using camera Transform
    ...
    //translate
        ...
        {
             transform.Translate(originCamera.transform.up*(5)*Time.deltaTime);
    ...
    //Rotate
       ...
       // if(position=(position=InputTracking.GetLocalRotation(XRNode.CenterEye).Unity2Ros()).x!=pre_positoin.x)
