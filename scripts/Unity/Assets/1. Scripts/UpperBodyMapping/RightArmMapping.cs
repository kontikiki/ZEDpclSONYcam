...
namespace Valve.VR
{
    ...
    public class RightArmMapping : MonoBehaviour
    {
        public enum EIndex
        {
            None = -1,
    ...
    bool forwardFlag=false;
        ...
        private void OnNewPoses(TrackedDevicePose_t[] poses)
        {
           ...
           // Debug.Log("cali_rot x:"+cali_rot.x);
             ...
             rightForeArm.transform.localRotation=processedXRotation;
             rightElbow1.transform.localRotation=processedZRotation;
       ...
       if(Physics.Raycast(cam.transform.position,forward,out hit))
        {
           ...
           if(stillFlag==false && hit.transform.tag=="Button2")
            ...
            else if(forwardFlag==false && hit.transform.tag=="Button2")
            {
                ...
                forwardFlag=true;
                measureLS();
                Debug.Log("Forward pose measurement of RIGHTARM end.");
                }
            }       
         }
         }
