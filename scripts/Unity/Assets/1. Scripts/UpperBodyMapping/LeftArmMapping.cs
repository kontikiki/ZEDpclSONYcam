...
namespace Valve.VR
{
    ...
    public class LeftArmMapping : MonoBehaviour
    {
        public enum EIndex
        {
            None = -1,
...
/*
            ...
            //    (pose.pos.x-forwardPose.pos.x),
            //    (pose.pos.y-forwardPose.pos.y),
            //    (pose.pos.z-forwardPose.pos.z));
            ...
            //(pose.rot.x-forwardPose.rot.x),
            //(pose.rot.y-forwardPose.rot.y),
            //(pose.rot.z-forwardPose.rot.z),
            //(pose.rot.w-forwardPose.rot.w));
...
*/
            ...
            //leftForeArm.transform.localPosition=cali_pos;
            //leftElbow1.transform.localPosition=cali_rot;

             leftForeArm.transform.localRotation=processedXRotation;
             leftElbow1.transform.localRotation=processedZRotation;
       ...
       if(Physics.Raycast(cam.transform.position,forward,out hit))
        {
            ...
            {
                pointer.fillAmount=timeElapsed2/2;
           ...
           else if(stillFlag==false && hit.transform.tag=="Button2")
            {   
                ...
                //if(timeElapsed>=2 && (Input.GetKeyDown(KeyCode.G)))
                {
                    ...
                    hit.transform.GetComponent<Button>().onClick.Invoke();
                    timeElapsed2=0;
                   //pointer.fillAmount=timeElapsed2;
                stillFlag=true;
                measureLA();
        
                detailText.text=string.Format("LEFT ARM Still pose measurement complete."+"\n"
            ...
            else if(TFlag==false && hit.transform.tag=="Button2")
            {
                ...
                detailText.text=string.Format("LEFT ARM T pose measurement complete."+"\n"
            ...
            else if(forwardFlag==false && hit.transform.tag=="Button2")
            {
               ...
               detailText.text=string.Format(
                   "LEFT ARM Forward pose measurement complete."+"\n"
