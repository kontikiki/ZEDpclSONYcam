...
namespace Valve.VR
{
    public class SteamVR_TrackedObject_sh1 : MonoBehaviour
    {
        public enum EIndex
        {
            None = -1,
 ...
 /*           
            ...
            Debug.Log("processed Rotation y: "+processedYRotation.y);
            transform.localRotation=processedYRotation;
            }
            else
            {
                */
