...
namespace Valve.VR
{
    public class SteamVR_TrackedObject_elbow : MonoBehaviour
    {
        public enum EIndex
        {
            None = -1,
        ...
        //static private SteamVR_Utils.RigidTransform pre_pose=new SteamVR_Utils.RigidTransform();
 ...
 //               transform.rotation = origin.rotation* pose.rot;
            ...
            Debug.Log("processed Rotation Z: "+processedZRotation.z);
            transform.localRotation=processedZRotation;
            }
            else
            {
   */            
                 Vector3 eulerAng=cali_rot.eulerAngles;
                //Vector3 eulerPreAng=(pre_pose.rot).eulerAngles;
                 Quaternion processedZRotation=Quaternion.Euler(new Vector3(0,0,eulerAng.z));
                 Debug.Log("processed Rotation Z: "+processedZRotation.z);
                // Quaternion processedLastRotation=new Quaternion(0,processedYRotation.y,0,0);
