    ...
    public class PoseStampedPublisher : UnityPublisher<MessageTypes.Geometry.PoseStamped>
    {
       // public Transform PublishedTransform;
        ...
        private void UpdateMessage()
        {
            ...
            GetGeometryPoint(InputTracking.GetLocalPosition(XRNode.CenterEye).Unity2Ros(), message.pose.position);
            GetGeometryQuaternion(InputTracking.GetLocalRotation(XRNode.CenterEye).Unity2Ros(), message.pose.orientation);
            Publish(message);
        }
